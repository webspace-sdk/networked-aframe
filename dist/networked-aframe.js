	...
	AFRAME.registerComponent('networked', {
	  ...
	  tick: function tick() {
	    ...
	    if (!this.isMine()) {
	      ...
	      try {
	        for (var _iterator2 = this.rotationComponents[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	          var rotComp = _step2.value;
	      ...
	      try {
	        for (var _iterator3 = this.scaleComponents[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	          var scaleComp = _step3.value;
